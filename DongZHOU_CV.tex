...
Familiar with computer-aided drug design, magnetic resonance imaging, quantum computing, and biophysics.

%------------------------------------------------------------------------------


\section{\sc Skills}
Python, Go, C/\Cplusplus, Matlab, Shell scripts, D3.js, SQL \\
...
\begin{itemize}
\item Senior scientist at Schr\"odinger, Inc. \hfill 2016-2017
...
Reviewer for Journal of Physics A: mathematical and theoretical, IEEE TBME, PLOS ONE, Quantum Information Processing, New Journal of Physics, Medicine, Journal of Neuroscience Methods, NeuroImage, Magnetic Resonance in Medicine, Medical Physics, NMR in Biomedicine
...
\begin{enumerate}[leftmargin=-0.1in]
\item {\em Quantitative Susceptibility Mapping (QSM)-Based Cerebral Metabolic Rate of Oxygen (CMRO2) Mapping with Minimum Local Variance (MLV)}\\
J. Zhang, J. Cho, {\bf D. Zhou}, T.D. Nguyen, P. Spincemaille, A. Gupta, and Y. Wang, submitted to MRM (2016)
\item {\em Quantitative susceptibility mapping of magnetic quadrupole moments}\\
J. Cho, {\bf D. Zhou}, Y. Kee, P. Spincemaille, Y. Wang, submitted to Magn Reson Med, (2016)
\item {\em Susceptibility underestimation in a high susceptibility
phantom: dependence on imaging resolution, magnitude
contrast and other parameters}\\
{\bf D. Zhou}, J. Zhang, P. Spincemaille, Y. Wang, accepted by Magn Reson Med, (2016)
\item {\em Preconditioned Total Field Inversion (TFI) Method for
Quantitative Susceptibility Mapping} \\
Z. Liu, Y. Kee, {\bf D. Zhou}, Y. Wang, and P. Spincemaille, accepted by Magn Reson Med (2016)
...
J. Zhang, {\bf D. Zhou}, P. Spincemaille, Y. Wang, accepted by Magn Reson Med, (2016)
...
Y. Zhang, S.A. Gauthier, A. Gupta, W. Chen, J. Comunale, G.C.-Y. Chiang, {\bf D. Zhou}, G. Askin, W. Zhu, D. Pitt, Y. Wang, acceptted by AJNR,  (2016).
\item {\em Three-dimensional MR Phase Unwrapping via Dual Decomposition} \\
J. Dong, F. Chen,  {\bf D. Zhou}, T. Liu, Z. Yu, and Y. Wang, accepted by Magn Reson Med (2016).
