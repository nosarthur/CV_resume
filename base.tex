...
Author of 30+ journal articles with 1000+ citations. Reviewer for 10+ journals.
...
\section{\sc Skills}
Python, C/\Cplusplus, Go, Matlab, AWS, SQL\\
...
Implement library for molecular dynamics trajectories analysis using Python and \Cplusplus.
...
susceptibility tensor imaging, magnetic quadrupole imaging, phase unwrapping, etc,
using Matlab, C, and \Cplusplus.
...
Developed state preparation scheme using quantum bath engineering, and
two-qubit CNOT gate scheme using adiabatic phase on circuit QED hardware (3D transmon).
...
Solved open quantum systems dynamics in the presence of classical noises
(stochastic processes) both analytically and numerically using Matlab and \Cplusplus.
