...
\section{\sc Skills}
Python, C/\Cplusplus, Go, Matlab, Bash scripts, AWS, SQL\\
...
Simulated solid state quantum optics systems (circuit QED) using Python.
...
Developed schemes for quantum gate and quantum control.
